...
parisians-own [ act1? act2? PatchResidence PatchA1 PatchA2 EduLevel Healthy? age sex opinion constraint-budget constraint-time
...
to doA1
  ...
  count-minority
  ask parisians with [act1? = 1] [Identify-if-interactive]
  ask parisians with [act1? = 1] [Update-interaction]
   ask parisians with [act1? = 1] [Update-opinion-behaviour]
end
...
to doA2
  ...
  count-minority
   ...
   ask parisians with [act2? = 1] [Identify-if-interactive]
  ask parisians with [act2? = 1] [Update-interaction]
   ask parisians with [act2? = 1] [Update-opinion-behaviour]
