...
parisians-own [ act1? act2? PatchResidence PatchA1 PatchA2 EduLevel Healthy? age sex opinion constraint-budget constraint-time csv_o csv_v csv_a
...
to insert-csv
  ...
  ask parisians[
    file-print csv:to-row (list who age sex EduLevel csv_a  )
  ]
  ...
  ask parisians[
    file-print csv:to-row (list who age sex EduLevel csv_v)
  ]
...
to update-opinion
  ...
  set csv_v lput nbvoisin csv_v
  set csv_a lput nbpartenaire csv_a
end
